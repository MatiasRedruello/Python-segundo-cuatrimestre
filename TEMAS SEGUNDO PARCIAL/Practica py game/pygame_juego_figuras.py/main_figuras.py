...
bullet_image = pygame.image.load('C:/Users/PC/OneDrive/Documents/GitHub/Python-segundo-cuatrimestre/TEMAS SEGUNDO PARCIAL/Practica py game/pygame_juego_figuras.py/Power/gema_roja.png').convert_alpha()
bullet_width = 30
bullet_height = 15

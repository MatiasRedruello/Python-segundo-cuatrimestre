...
img_fondo = pygame.image.load(r'SEMANA 6/PYGAME_PUNTAJES/recursos/img/fondo.png')

# Cargamos la imagen de la tabla
img_tabla_puntajes = pygame.image.load(r'SEMANA 6/PYGAME_PUNTAJES/recursos/img/tabla_puntajes.png')
pos_img_tabla_puntajes = ((ANCHO_VENTANA - img_tabla_puntajes.get_width()) // 2, 10)

# Creamos el texto del titulo
font_titulo = pygame.font.Font(r'SEMANA 6/PYGAME_PUNTAJES/recursos/fonts/Halimount.otf', 50)
...
font_boton = pygame.font.Font(r'SEMANA 6/PYGAME_PUNTAJES/recursos/fonts/Halimount.otf', 30)
txt_boton = font_boton.render(r"Jugar de nuevo", True, "white")
pos_txt_boton = ((ANCHO_VENTANA - txt_titulo.get_width()) // 2, 515)

# Creamos el texto de la tabla
font_tabla = pygame.font.Font(r'SEMANA 6/PYGAME_PUNTAJES/recursos/fonts/Halimount.otf', 35)
lista_puntaje_txt = []
